<template>
  <div>
    ...
    >
      ...
      <h2 class="project-tagline">{{ projects.bio }}</h2>
      <a
        href="https://gitee.com/xility"
        class="btn"
        target="_blank"
        >码云主页</a
      >
      <a
        href="https://gitee.com/xility/gridsome-blog.git"
        class="btn"
        target="_blank"
        >博客源码</a
      >
        ...
        <el-row>
          ...
          <el-col :span="2" style="text-align: center">
            ...
            <el-popover
              ...
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>&emsp;{{ projects.name }}
              <br />
              <i class="el-icon-location"></i>&emsp;{{ projects.location }}
              <br />
              <img
                :src="projects.avatar_url"
